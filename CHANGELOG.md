...
The format is based on Keep a Changelog, and this project adheres to Calendar Versioning of the following
form: 2025.10.17
Added
...
### Updated
 ...
 10/17/25
Created the intial music componenet
MAde the kernel methods such as add, remove, size and clear
Secondary methods were initally touchef/will be fixed next time and more
added.
...
- All implementations for secondary methods were done in the absract class
Contains done
shuffle done
remove dup done
- Went back and added a new Kernel method remove any which was nessecary for me to able to implement these.

## Updated

[11/21/25]
Chose ArrayList for the data structure and Added the constructor.
